...
| 3 — commitment | money, health, legal, publishing, irreversible moves | multi-angle sweep, primary sources required, adversarial verification of EVERY load-bearing claim, contradictions resolved per [[claim-level-provenance]] |
...
Contradicting evidence (protocol in [[claim-level-provenance]]); staleness of
