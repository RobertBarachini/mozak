...
`pages/mozak-report-annotation-loop.md`.
...
2. **Run the drain contract in `pages/mozak-report-annotation-loop.md` (the "Drain" section).**
...
`pages/mozak-report-annotation-loop.md` and follow it, so this skill never drifts from it.
